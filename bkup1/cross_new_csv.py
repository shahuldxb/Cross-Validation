...
Compare the following documents and identify only cross-document (B-type) discrepancies.
...
REPEAT THIS COMPLETE TEMPLATE FOR EVERY SINGLE DISCREPANCY FOUND - NO EXCEPTIONS, NO OMISSIONS.
"""
